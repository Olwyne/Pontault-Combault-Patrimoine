<template>
    <div class="navigation">
        <ul class="nav nav-fill">
            <li class="nav-item">
                <a class="nav-link" @click="setActivePage('Accueil'),activePage='Accueil',setActiveTitle('Accueil')">
            ...
            <li class="nav-item">
                <a class="nav-link" @click="setActivePage('VisiteLibre'),activePage='VisiteLibre',setActiveTitle('Visite Libre')">
            ...
            <li class="nav-item">
                <a class="nav-link" @click="setActivePage('Balades'),activePage='Balades',setActiveTitle('Balades')">
		...
		C207.2,60.9,224.8,78.5,246.4,78.5z" />
                    ...
                    <path :class="activePage==='Balades'?'colorNavActive':'colorNavDefault'" d="M386.6,202.9c0-11.2-9.1-20.3-20.3-20.3h-68.5l-38.6-54.8l0.1-0.9c1.4-10.5-1.5-21.1-7.9-29.4
		...
		l1.3,232.3c0,4.5,3.6,8.1,8.1,8.1c4.5,0,8.1-3.6,8.1-8.1l-1.3-234C381.6,218.2,386.6,211.1,386.6,202.9z" />
            ...
            <li class="nav-item">
                <a class="nav-link" @click="setActivePage('Carnet'),activePage='Carnet',setActiveTitle('Carnet')">
                    ...
                    <g>
                    <path :class="activePage==='Carnet'?'colorNavActive':'colorNavDefault'" d="M150,240.1H392V90H150V240.1z M180.1,120h181.9v30H180.1V120z M180.1,180.1h181.9v30H180.1V180.1z" />
		...
		H30v30h30v30H482V0L60,0z M120,270.1V60H422v210.1H120z" />
            ...
            <li class="nav-item">
                <a class="nav-link" @click="setActivePage('Jeu'),activePage='Jeu',setActiveTitle('Jeu')">
                   <img class="icon-nav" src="../img/poco-head2.png" />
                </a>
            </li>
        </ul>
    </div>
